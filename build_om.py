...
/* ════ GOOGLE MAPS ════ */
.gmap{{height:460px;border-radius:8px;border:1px solid #ddd;margin-bottom:30px;box-shadow:0 2px 10px rgba(0,0,0,.08);background:#f0f4f8}}
...
// Single callback for both maps, fired by Google Maps JS API on load
function initMaps(){{
...
<!-- Maps API loaded last so initMaps is always defined before the callback fires (avoids the race on this image-heavy single-file page) -->
